...
func TestResolver(t *testing.T) {
	...
	tgt := resolver.Target{URL: url.URL{Opaque: l.Addr().String()}}
	require.NoError(t, err)
	_, err = r.Build(
		tgt,
		conn,
...
type serversGetter struct{}

func (s *serversGetter) GetServers() ([]*api.Server, error) {
	return []*api.Server{{
		Id:       "leader",
